/**
 * שליפת תוכן דינמי (עדכוני מתנדבים) מגיליון Google Sheets שפורסם כ-CSV.
 * File > Share > Publish to web > בחר את הגיליון הרלוונטי > CSV.
 * רץ client-side כדי שעדכון בגיליון יופיע באתר בלי rebuild.
 */
